...
class GoveronmentDepartmentController extends \BaseController {

		private $heading="Goveronment Department";

	public function index()
	{
		$heading=$this->heading;
		$records=GoveronmentDepartment::getAllRecords();
		$display_fields=array('name');
		$labels=GoveronmentDepartment::getLabels();
		$current_route_base='govdeps';
		$create_link='govdeps.create';
		$iec_link='';
		$delete_link='govdeps.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']=array();
		 $data['submit_url']='govdeps.store';
		 $data['upload_submit_url']='govdeps.excel';
		 $data['heading']=$this->heading;
		 $data['go_back']='govdeps.index';
	...
	public function store()
	{
		...
		$record=new District;
		$this->save_db($record,'govdeps/create','Successfully created the record!');
		return Redirect::route('govdeps.index');
	}
	...
	{
		$record=GoveronmentDepartment::find($id);	
		if(!$record){return;}
	...
	public function edit($id)
	{
		...
		$data['submit_url']='govdeps.update';
		$data['heading']=$this->heading;
		$data['go_back']='govdeps.index';
	...
	public function update($id)
	{
		...
		$record=GoveronmentDepartment::find($id);
		$this->save_db($record,'govdeps.edit','Successfully updated the record!');
		return Redirect::route('govdeps.index');
	...
	{
		GoveronmentDepartment::destroy($id);
	...
	public function save_db($record,$error_redirect,$success_msg){
		...
		$fields=GoveronmentDepartment::getFillables();
		$rules=array();
