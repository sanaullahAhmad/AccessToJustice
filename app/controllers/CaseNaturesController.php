...
class CaseNaturesController extends \BaseController {

		private $heading="Case Natures";

	public function index()
	{
		$heading=$this->heading;
		$records=CaseNature::getAllRecords();
		$display_fields=array('name','status','casegroup');
		$labels=CaseNature::getLabels();
		$current_route_base='casenature';
		$create_link='casenature.create';
		$iec_link='';
		$delete_link='casenature.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']=array();
		 $data['submit_url']='casenature.store';
		 $data['upload_submit_url']='casenature.excel';
		 $data['heading']=$this->heading;
		 $data['go_back']='casenature.index';
	...
	public function edit($id)
	{
		...
		$data['submit_url']='casenature.update';
		$data['heading']=$this->heading;
		$data['go_back']='casenature.index';
	...
	public function update($id)
	{
		...
		$record=CaseNature::find($id);
		$this->save_db($record,'casenature.edit','Successfully updated the record!');
		return Redirect::route('casenature.index');
	...
	public function save_db($record,$error_redirect,$success_msg){
		...
		$fields=CaseNature::getFillables();
		$rules=array();
