...
class CallNaturesController extends \BaseController {

	private $heading="Call Natures";

	public function index()
	{
		$heading=$this->heading;
		$records=CallNature::getAllRecords();
		$display_fields=array('name','status');
		$labels=CallNature::getLabels();
		$current_route_base='callnature';
		$create_link='callnature.create';
		$iec_link='';
		$delete_link='callnature.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']=array();
		 $data['submit_url']='callnature.store';
		 $data['upload_submit_url']='callnature.excel';
		 $data['heading']=$this->heading;
		 $data['go_back']='callnature.index';
	...
	public function store()
	{
		...
		$record=new CallNature;
		$this->save_db($record,'CallNatures/create','Successfully created the record!');
		return Redirect::route('callnature.index');
	}
	...
	public function edit($id)
	{
		...
		$data['submit_url']='callnature.update';
		$data['heading']=$this->heading;
		$data['go_back']='callnature.index';
	...
	public function update($id)
	{
		...
		$record=CallNature::find($id);
		$this->save_db($record,'callnature.edit','Successfully updated the record!');
		return Redirect::route('callnature.index');
	...
	public function save_db($record,$error_redirect,$success_msg){
		...
		$fields=CallNature::getFillables();
		$rules=array();
