...
class ProblemNaturesController extends \BaseController {

		private $heading="Problem Natures";

	public function index()
	{
		$heading=$this->heading;
		$records=ProblemNature::getAllRecords();
		$display_fields=array('name','status','problemgroup');
		$labels=ProblemNature::getLabels();
		$current_route_base='problem';
		$create_link='problem.create';
		$iec_link='';
		$delete_link='problem.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']           =   array();
		 $data['submit_url']        =   'problem.store';
		 $data['upload_submit_url'] =   'problem.excel';
		 $data['heading']           =   $this->heading;
		 $data['go_back']           =   'problem.index';
	...
	public function store()
	{
		...
		$record=new ProblemNature;
		$this->save_db($record,'ProblemNatures/create','Successfully created the record!');
	...
	public function edit($id)
	{
		...
		$data['submit_url']='problem.update';
		$data['heading']=$this->heading;
		$data['go_back']='problem.index';
	...
	public function update($id)
	{
		...
		$record=ProblemNature::find($id);
		$this->save_db($record,'problem.edit','Successfully updated the record!');
		return Redirect::route('problem.index');
	...
	public function save_db($record,$error_redirect,$success_msg){
		...
		$fields=ProblemNature::getFillables();
		$rules=array();
