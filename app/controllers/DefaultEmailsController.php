...
class DefaultEmailsController extends \BaseController {

		private $heading="Default Emails";

	public function index()
	{
		$heading=$this->heading;
		$records=DefaultEmail::getAllRecords();
		$display_fields=array('name','email');
		$labels=DefaultEmail::getLabels();
		$current_route_base='defaultemail';
		$create_link='defaultemail.create';
		$iec_link='';
		$delete_link='defaultemail.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']=array();
		 $data['submit_url']='defaultemail.store';
		 $data['upload_submit_url']='defaultemail.excel';
		 $data['heading']=$this->heading;
		 $data['go_back']='defaultemail.index';
	...
	public function edit($id)
	{
		...
		$data['submit_url']='defaultemail.update';
		$data['heading']=$this->heading;
		$data['go_back']='defaultemail.index';
	...
	public function update($id)
	{
		...
		$record=DefaultEmail::find($id);
		$this->save_db($record,'defaultemail.edit','Successfully updated the record!');
		return Redirect::route('defaultemail.index');
	...
	public function save_db($record,$error_redirect,$success_msg){
		...
		$fields=DefaultEmail::getFillables();
		$rules=array();
