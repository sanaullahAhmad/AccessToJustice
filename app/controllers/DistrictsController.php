...
class DistrictsController extends \BaseController {
		...
		private $heading="Districts";

	public function index()
	{
		$heading=$this->heading;
		$records=District::getAllRecords();
		$display_fields=array('name');
		$labels=District::getLabels();
		$current_route_base='district';
		$create_link='district.create';
		$iec_link='';
		$delete_link='district.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']=array();
		 $data['submit_url']='district.store';
		 $data['upload_submit_url']='district.excel';
		 $data['heading']=$this->heading;
		 $data['go_back']='district.index';
	...
	public function store()
	{
		...
		$record=new District;
		$this->save_db($record,'Districts/create','Successfully created the record!');
	...
	public function edit($id)
	{
		...
		$data['submit_url']='district.update';
		$data['heading']=$this->heading;
		$data['go_back']='district.index';
	...
	public function update($id)
	{
		...
		$record=District::find($id);
		$this->save_db($record,'district.edit','Successfully updated the record!');
		return Redirect::route('district.index');
