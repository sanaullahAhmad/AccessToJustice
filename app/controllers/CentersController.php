...
private $heading="Legal Aid Centers";

	public function index()
	{
		$heading=$this->heading;
		$records=Center::getAllRecords();
		$display_fields=array('name', 'address', 'timings', 'phone', 'mobile'
								, 'district_id', 'partner_id', 'coordinator');

		$labels=Center::getLabels();
		$current_route_base='center';
		$create_link='center.create';
		$iec_link='iec.index';
		$delete_link='center.delete';
		$excel_download_link='';
		$pdf_download_link='';
	...
	public function create()
	{
		 ...
		 $data['centers']=array();
		 $data['submit_url']='center.store';
		 $data['upload_submit_url']='center.excel';
		 $data['heading']=$this->heading;
		 $data['go_back']='center.index';
	...
	public function store()
	{
		...
		$record=new Center;
		$this->save_db($record,'Centers/create','Successfully created the record!');
	...
	public function update($id)
	{
		...
		$record=Center::find($id);
		$this->save_db($record,'center.edit','Successfully updated the record!');
		return Redirect::route('center.index');
	...
	public function generate_form($values=array()){
		...
		$options=array(
			...
			'partner_id'=>retrieveField(Partner::all(),'name')
		);
