...
class CenterStaff extends Eloquent{
	
	protected $fillable = array('name','designation','phone','email','trained','center_id');
	...
	protected function getLabels(){
		...
		$labels= array('Name','Designation','Phone','Email','Training Attended','Center');
